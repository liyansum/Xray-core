...
> This fork is a slim XrayR core. VMess, VLESS, REALITY, gRPC transport,
> mKCP/KCP, HTTPUpgrade, and XHTTP/SplitHTTP have been removed. Supported
> production transports are RAW/TCP, WebSocket, UDP, and TLS.
